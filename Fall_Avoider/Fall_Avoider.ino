...
void setup() {
  // put your setup code here, to run once:  //Use when calibrating according to your surroundings
//Serial.begin(9600);
pinMode(acleft4, 1);
pinMode(cleft5, 1);
pinMode(acright6, 1);
...
Serial.println(y);*/
analogWrite(pwm,75);   // Use only if you want to control the speed of dc motor
analogWrite(pwm1,75);   // Use only if you want to control the speed of dc motor
if (x > 500 || y > 500)            
  {
    digitalWrite(cright7, 0);  // moving backward
